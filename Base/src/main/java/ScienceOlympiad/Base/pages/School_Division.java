...
//- A continue button will then take you to the following page: School_List


public class School_Division {
	...
	//Injects the School_Data page so that it can be accessed after form submission
	@Property
	@InjectPage
	...
	@SessionState
	static Integer schoolDivisionOffpagePK = null;
	
	//Injecting the Cayenne Service
	static String toDisplay = null;
	...
	Object onSuccess() {
			...
			schoolDivisionOffpagePK = divisionPK;
			schoolList.set(schoolDivisionOffpagePK);
